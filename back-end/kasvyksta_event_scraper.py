    ...
    def run(self):
        while 1:
            ...
            for row in rows:
                ...
                lst.append((eventName, placeName, link, address, city, startDate, public, user_added_id, photo_url, clicks))
                ...
                try:
                    cur.execute(sql, (eventName, placeName, link, address, city, startDate, public, user_added_id, photo_url, clicks))
                    id = cur.fetchone()[0]
